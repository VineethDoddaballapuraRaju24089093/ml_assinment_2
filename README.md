...
| File | Figure | Section |
|------|--------|---------|
| `fig1_margin.png` | Decision boundary, margin & support vectors (toy data) | §2 |
| `fig2_kernels_boundary.png` | Decision boundaries for three kernels on the Moons dataset | §4 |
| `fig3_wine_scatter.png` | Wine dataset scatter: Alcohol vs Flavanoids | §5 |
| `fig4_accuracy_comparison.png` | Train/test accuracy comparison — five kernel configurations | §8 |
| `fig5_rbf_heatmap.png` | RBF accuracy heatmap: C vs gamma | §9 |
| `fig6_standardisation_effect.png` | Effect of skipping StandardScaler (try-it exercise) | §6 |
| `fig7_all_kernels_comparison.png` | All kernels compared including custom Laplacian | §13 |
| `fig8_confusion_matrix.png` | Confusion matrix for the best-tuned RBF SVM | §11 |
